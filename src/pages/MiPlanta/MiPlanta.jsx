...
const UpperPanel = () => {
  return (
    <>
      <Panel shaded>
        <Stack justifyContent="flex-start" spacing={6} style={{marginLeft: 75}}>
          <div>
            <label
              style={{
                fontSize: 20,
...
const HumedadMinima = () => {
  ...
  return (
    <>
      ...
      <Row>
        <Col md={6}>
          <div style={{ width: 180, marginTop: 10, marginLeft: 100, display: "block" }}>
            <Progress.Circle percent={percent} strokeColor={color} status={status} />
          </div>
        </Col>
      </Row>
      <label style={{marginLeft: 95, marginTop: 12, fontSize: 24, display: "block"}}>
        Humedad Mínima
      </label>
    </>
  );
...
const TemperaturaMaxima = () => {
  return(
    <>
      <label style={{fontSize: 48, marginLeft: 80, marginTop: 128, paddingBottom: 40, display: "block"}}>
        35°C
      </label>
